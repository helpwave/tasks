...
class LocationValidator:
    @staticmethod
    def validate_kind(
        location: models.LocationNode, expected_kind: str, field_name: str
    ) -> None:
    ...
    @staticmethod
    def validate_position_kind(
        location: models.LocationNode, field_name: str
    ) -> None:
        allowed_kinds = {
            "HOSPITAL",
            "PRACTICE",
