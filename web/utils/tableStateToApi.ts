...
function toFilterParameter(value: FilterValue, propertyDefinitionId?: string): FilterParameter {
  ...
  const param: FilterParameter = {
    ...
    compareDate: parameter.compareDate,
    minDate: parameter.minDate,
    maxDate: parameter.maxDate,
    compareDateTime: parameter.compareDate?.toISOString(),
    minDateTime: parameter.minDate?.toISOString(),
    maxDateTime: parameter.maxDate?.toISOString(),
    searchTags,
