...
export type TasksTranslationEntries = {
  ...
  'assistantApiKeyHint': string,
  'assistantBaseUrl': string,
  'assistantBaseUrlHint': string,
  'assistantClearChat': string,
  'assistantConfigure': string,
  'assistantDemoNotice': string,
  'assistantEmptyMessage': string,
  'assistantErrorGeneric': string,
  'assistantFocusGeneral': string,
  'assistantFocusHint': string,
  'assistantFocusLabel': string,
  'assistantFocusPatients': string,
  'assistantFocusPlaceholder': string,
  'assistantFocusTasks': string,
  'assistantInputPlaceholder': string,
  'assistantModel': string,
  'assistantModelHint': string,
  'assistantNoApiKey': string,
  'assistantSaveKey': string,
  'assistantSelectFocus': string,
  'assistantSend': string,
  'assistantSending': string,
  'assistantStarterLocationScope': string,
  'assistantStarterPatientOverview': string,
  'assistantStarterTaskHowTo': string,
...
export const tasksTranslation: Translation<TasksTranslationLocales, Partial<TasksTranslationEntries>> = {
  'de-DE': {
    ...
    'assistantApiKey': `API-Schlüssel`,
    'assistantApiKeyHint': `Nur lokal in diesem Browser gespeichert`,
    'assistantBaseUrl': `API-Basis-URL (optional)`,
    'assistantBaseUrlHint': `Leer lassen für OpenAI. Für Ollama http://localhost:11434/v1`,
    'assistantClearChat': `Chat leeren`,
    'assistantConfigure': `Modell & API-Schlüssel`,
    'assistantDemoNotice': `Demo: Ihr API-Schlüssel wird nur in diesem Browser gespeichert. Jede Nachricht leitet den Schlüssel über diese App an Ihren Anbieter—keine Produktions-Geheimnisse verwenden.`,
    'assistantEmptyMessage': `Bitte eine Nachricht eingeben.`,
    'assistantErrorGeneric': `Etwas ist schiefgelaufen. Prüfen Sie Schlüssel, Modell und Netzwerk.`,
    'assistantFocusGeneral': `App-Bedienung`,
    'assistantFocusHint': `Wählen Sie einen Fokus, damit Antworten in dieser Demo thematisch passen.`,
    'assistantFocusLabel': `Gesprächsfokus (Pflicht)`,
    'assistantFocusPatients': `Patienten (keine personenbezogenen Daten)`,
    'assistantFocusPlaceholder': `Fokus wählen…`,
    'assistantFocusTasks': `Aufgaben & Abläufe`,
    'assistantInputPlaceholder': `Fragen zur Nutzung von helpwave tasks…`,
    'assistantModel': `Modell`,
    'assistantModelHint': `z. B. gpt-4o-mini oder eine Modell-ID Ihres Anbieters`,
    'assistantNoApiKey': `API-Schlüssel hinzufügen und speichern, um zu starten.`,
    'assistantSaveKey': `Speichern`,
    'assistantSelectFocus': `Bitte Gesprächsfokus wählen, bevor Sie senden.`,
    'assistantSend': `Senden`,
    'assistantSending': `Wird gesendet…`,
    'assistantStarterLocationScope': `Was ist ein Stamm-Standort und wie beeinflusst er meine Ansicht?`,
    'assistantStarterPatientOverview': `Wie funktioniert die Patientenliste und was bedeuten die Patientenstatus?`,
    'assistantStarterTaskHowTo': `Wie erstelle, weise ich zu und erledige ich eine Aufgabe in dieser App?`,
    'assistantSuggestedPrompts': `Vorschläge`,
    'assistantTitle': `Assistent`,
    'assistantTooltip': `Demo-Assistent öffnen (eigener API-Schlüssel)`,
  ...
  'en-US': {
    ...
    'assistantApiKey': `API key`,
    'assistantApiKeyHint': `Stored locally in this browser only`,
    'assistantBaseUrl': `API base URL (optional)`,
    'assistantBaseUrlHint': `Leave empty for OpenAI. For Ollama use http://localhost:11434/v1`,
    'assistantClearChat': `Clear chat`,
    'assistantConfigure': `Model & API key`,
    'assistantDemoNotice': `Demo: your API key is stored only in this browser. Each message sends the key through this app to your chosen provider—do not use production secrets.`,
    'assistantEmptyMessage': `Enter a message.`,
    'assistantErrorGeneric': `Something went wrong. Check your key, model, and network.`,
    'assistantFocusGeneral': `Using the app`,
    'assistantFocusHint': `Pick a focus so answers stay on-topic for this demo.`,
    'assistantFocusLabel': `Conversation focus (required)`,
    'assistantFocusPatients': `Patients (no PHI)`,
    'assistantFocusPlaceholder': `Select a focus…`,
    'assistantFocusTasks': `Tasks & workflows`,
    'assistantInputPlaceholder': `Ask about using helpwave tasks…`,
    'assistantModel': `Model`,
    'assistantModelHint': `e.g. gpt-4o-mini or a model id from your provider`,
    'assistantNoApiKey': `Add and save your API key to start.`,
    'assistantSaveKey': `Save`,
    'assistantSelectFocus': `Choose a conversation focus before sending.`,
    'assistantSend': `Send`,
    'assistantSending': `Sending…`,
    'assistantStarterLocationScope': `What is a root location and how does it affect what I see?`,
    'assistantStarterPatientOverview': `How does the patient list work and what do patient states mean?`,
    'assistantStarterTaskHowTo': `How do I create, assign, and complete a task in this app?`,
    'assistantSuggestedPrompts': `Suggested prompts`,
    'assistantTitle': `Assistant`,
    'assistantTooltip': `Open demo assistant (bring your own API key)`,
  ...
  'es-ES': {
    ...
    'assistantApiKey': `Clave API`,
    'assistantApiKeyHint': `Solo almacenada localmente en este navegador`,
    'assistantBaseUrl': `URL base de la API (opcional)`,
    'assistantBaseUrlHint': `Vacío para OpenAI. Ollama: http://localhost:11434/v1`,
    'assistantClearChat': `Borrar chat`,
    'assistantConfigure': `Modelo y clave API`,
    'assistantDemoNotice': `Demo: su clave API solo se guarda en este navegador. Cada mensaje envía la clave a través de esta app a su proveedor—no use secretos de producción.`,
    'assistantEmptyMessage': `Escriba un mensaje.`,
    'assistantErrorGeneric': `Algo falló. Revise clave, modelo y red.`,
    'assistantFocusGeneral': `Uso de la app`,
    'assistantFocusHint': `Elija un enfoque para mantener las respuestas alineadas con esta demo.`,
    'assistantFocusLabel': `Enfoque de la conversación (obligatorio)`,
    'assistantFocusPatients': `Pacientes (sin datos clínicos)`,
    'assistantFocusPlaceholder': `Seleccione un enfoque…`,
    'assistantFocusTasks': `Tareas y flujos`,
    'assistantInputPlaceholder': `Pregunte sobre el uso de helpwave tasks…`,
    'assistantModel': `Modelo`,
    'assistantModelHint': `p. ej. gpt-4o-mini o el id de su proveedor`,
    'assistantNoApiKey': `Añada y guarde su clave API para empezar.`,
    'assistantSaveKey': `Guardar`,
    'assistantSelectFocus': `Elija un enfoque antes de enviar.`,
    'assistantSend': `Enviar`,
    'assistantSending': `Enviando…`,
    'assistantStarterLocationScope': `¿Qué es una ubicación raíz y cómo afecta lo que veo?`,
    'assistantStarterPatientOverview': `¿Cómo funciona la lista de pacientes y qué significan los estados?`,
    'assistantStarterTaskHowTo': `¿Cómo creo, asigno y completo una tarea en esta app?`,
    'assistantSuggestedPrompts': `Sugerencias`,
    'assistantTitle': `Asistente`,
    'assistantTooltip': `Abrir asistente de demo (su propia clave API)`,
  ...
  'fr-FR': {
    ...
    'assistantApiKey': `Clé API`,
    'assistantApiKeyHint': `Stockée localement dans ce navigateur uniquement`,
    'assistantBaseUrl': `URL de base de l'API (optionnel)`,
    'assistantBaseUrlHint': `Vide pour OpenAI. Ollama : http://localhost:11434/v1`,
    'assistantClearChat': `Effacer la discussion`,
    'assistantConfigure': `Modèle et clé API`,
    'assistantDemoNotice': `Démo : votre clé API est stockée uniquement dans ce navigateur. Chaque message transite par cette app vers votre fournisseur—n'utilisez pas de secrets de production.`,
    'assistantEmptyMessage': `Saisissez un message.`,
    'assistantErrorGeneric': `Une erreur s'est produite. Vérifiez la clé, le modèle et le réseau.`,
    'assistantFocusGeneral': `Utilisation de l'app`,
    'assistantFocusHint': `Choisissez un thème pour des réponses adaptées à cette démo.`,
    'assistantFocusLabel': `Thème de conversation (obligatoire)`,
    'assistantFocusPatients': `Patients (pas de données de santé)`,
    'assistantFocusPlaceholder': `Choisir un thème…`,
    'assistantFocusTasks': `Tâches et flux`,
    'assistantInputPlaceholder': `Posez une question sur helpwave tasks…`,
    'assistantModel': `Modèle`,
    'assistantModelHint': `ex. gpt-4o-mini ou l'id du modèle chez votre fournisseur`,
    'assistantNoApiKey': `Ajoutez et enregistrez votre clé API pour commencer.`,
    'assistantSaveKey': `Enregistrer`,
    'assistantSelectFocus': `Choisissez un thème avant d'envoyer.`,
    'assistantSend': `Envoyer`,
    'assistantSending': `Envoi…`,
    'assistantStarterLocationScope': `Qu'est-ce qu'un emplacement racine et comment affecte-t-il mon affichage ?`,
    'assistantStarterPatientOverview': `Comment fonctionne la liste des patients et que signifient les états ?`,
    'assistantStarterTaskHowTo': `Comment créer, assigner et terminer une tâche dans cette app ?`,
    'assistantSuggestedPrompts': `Suggestions`,
    'assistantTitle': `Assistant`,
    'assistantTooltip': `Ouvrir l'assistant démo (votre clé API)`,
  ...
  'nl-NL': {
    ...
    'assistantApiKey': `API-sleutel`,
    'assistantApiKeyHint': `Alleen lokaal in deze browser opgeslagen`,
    'assistantBaseUrl': `API-basis-URL (optioneel)`,
    'assistantBaseUrlHint': `Leeg voor OpenAI. Ollama: http://localhost:11434/v1`,
    'assistantClearChat': `Chat wissen`,
    'assistantConfigure': `Model & API-sleutel`,
    'assistantDemoNotice': `Demo: uw API-sleutel wordt alleen in deze browser opgeslagen. Elk bericht stuurt de sleutel via deze app naar uw provider—geen productiegeheimen gebruiken.`,
    'assistantEmptyMessage': `Voer een bericht in.`,
    'assistantErrorGeneric': `Er ging iets mis. Controleer sleutel, model en netwerk.`,
    'assistantFocusGeneral': `App gebruiken`,
    'assistantFocusHint': `Kies een thema zodat antwoorden bij deze demo passen.`,
    'assistantFocusLabel': `Gespreksthema (verplicht)`,
    'assistantFocusPatients': `Patiënten (geen klinische gegevens)`,
    'assistantFocusPlaceholder': `Kies een thema…`,
    'assistantFocusTasks': `Taken & workflows`,
    'assistantInputPlaceholder': `Vraag over het gebruik van helpwave tasks…`,
    'assistantModel': `Model`,
    'assistantModelHint': `bijv. gpt-4o-mini of model-id van uw provider`,
    'assistantNoApiKey': `Voeg uw API-sleutel toe en sla op om te starten.`,
    'assistantSaveKey': `Opslaan`,
    'assistantSelectFocus': `Kies een thema voordat u verzendt.`,
    'assistantSend': `Verzenden`,
    'assistantSending': `Verzenden…`,
    'assistantStarterLocationScope': `Wat is een root-locatie en hoe beïnvloedt die mijn weergave?`,
    'assistantStarterPatientOverview': `Hoe werkt de patiëntenlijst en wat betekenen de statussen?`,
    'assistantStarterTaskHowTo': `Hoe maak, wijs ik toe en rond ik een taak af in deze app?`,
    'assistantSuggestedPrompts': `Suggesties`,
    'assistantTitle': `Assistent`,
    'assistantTooltip': `Demo-assistent openen (eigen API-sleutel)`,
  ...
  'pt-BR': {
    ...
    'assistantApiKey': `Chave API`,
    'assistantApiKeyHint': `Armazenada apenas localmente neste navegador`,
    'assistantBaseUrl': `URL base da API (opcional)`,
    'assistantBaseUrlHint': `Vazio para OpenAI. Ollama: http://localhost:11434/v1`,
    'assistantClearChat': `Limpar chat`,
    'assistantConfigure': `Modelo e chave API`,
    'assistantDemoNotice': `Demo: sua chave API fica só neste navegador. Cada mensagem envia a chave por este app ao provedor—não use segredos de produção.`,
    'assistantEmptyMessage': `Digite uma mensagem.`,
    'assistantErrorGeneric': `Algo deu errado. Verifique chave, modelo e rede.`,
    'assistantFocusGeneral': `Uso do app`,
    'assistantFocusHint': `Escolha um foco para respostas alinhadas a esta demo.`,
    'assistantFocusLabel': `Foco da conversa (obrigatório)`,
    'assistantFocusPatients': `Pacientes (sem dados clínicos)`,
    'assistantFocusPlaceholder': `Selecione um foco…`,
    'assistantFocusTasks': `Tarefas e fluxos`,
    'assistantInputPlaceholder': `Pergunte sobre o uso do helpwave tasks…`,
    'assistantModel': `Modelo`,
    'assistantModelHint': `ex.: gpt-4o-mini ou id do modelo do provedor`,
    'assistantNoApiKey': `Adicione e salve sua chave API para começar.`,
    'assistantSaveKey': `Salvar`,
    'assistantSelectFocus': `Escolha um foco antes de enviar.`,
    'assistantSend': `Enviar`,
    'assistantSending': `Enviando…`,
    'assistantStarterLocationScope': `O que é localização raiz e como afeta o que vejo?`,
    'assistantStarterPatientOverview': `Como funciona a lista de pacientes e o que significam os estados?`,
    'assistantStarterTaskHowTo': `Como criar, atribuir e concluir uma tarefa neste app?`,
    'assistantSuggestedPrompts': `Sugestões`,
    'assistantTitle': `Assistente`,
    'assistantTooltip': `Abrir assistente demo (sua própria chave API)`,
