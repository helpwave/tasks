...
export const tasksTranslation: Translation<TasksTranslationLocales, Partial<TasksTranslationEntries>> = {
  'de-DE': {
    ...
    'assistantInputPlaceholder': `Frage stellen oder gewünschte Aktion beschreiben…`,
    'assistantModeHint': `Info beantwortet nur Nutzungsfragen. Working verbindet das Modell mit dem MCP-Server, damit Aufgaben und Patienten per GraphQL gelesen und geändert werden können.`,
    'assistantModeInfo': `Info — App-Bedienung`,
    'assistantModel': `Modell`,
    'assistantModeLabel': `Modus (Pflicht)`,
    'assistantModelHint': `z. B. gpt-4o-mini oder eine Modell-ID Ihres Anbieters`,
    'assistantModePlaceholder': `Modus wählen…`,
    'assistantModeWorking': `Working — MCP-Tools auf Live-Daten`,
    'assistantNoApiKey': `API-Schlüssel hinzufügen und speichern, um zu starten.`,
    'assistantSaveKey': `Speichern`,
    'assistantSelectMode': `Bitte einen Modus wählen, bevor Sie senden.`,
    ...
    'assistantWorkingMcpNotice': `Modus „Working“ nutzt den MCP-Server (Standard http://127.0.0.1:8765/mcp). Repo-Root: MCP_TRANSPORT=http MCP_GRAPHQL_URL=http://localhost:8000/graphql python -m mcp_server.server. Optional ASSISTANT_MCP_URL für Next.js.`,
  ...
  'en-US': {
    ...
    'assistantInputPlaceholder': `Ask a question or describe what you want to do…`,
    'assistantModeHint': `Info answers usage questions only. Working connects the model to the MCP server so it can list and change tasks and patients via GraphQL.`,
    'assistantModeInfo': `Info — how to use the app`,
    'assistantModel': `Model`,
    'assistantModeLabel': `Mode (required)`,
    'assistantModelHint': `e.g. gpt-4o-mini or a model id from your provider`,
    'assistantModePlaceholder': `Select a mode…`,
    'assistantModeWorking': `Working — MCP tools on live data`,
    'assistantNoApiKey': `Add and save your API key to start.`,
    'assistantSaveKey': `Save`,
    'assistantSelectMode': `Choose a mode before sending.`,
    'assistantSend': `Send`,
    'assistantSending': `Sending…`,
    'assistantTitle': `Assistant`,
    'assistantTooltip': `Open demo assistant (bring your own API key)`,
    'assistantWorkingMcpNotice': `Working mode calls the helpwave MCP server (default http://127.0.0.1:8765/mcp). From the repo root: MCP_TRANSPORT=http MCP_GRAPHQL_URL=http://localhost:8000/graphql python -m mcp_server.server. Override with ASSISTANT_MCP_URL for Next.js.`,
  ...
  'es-ES': {
    ...
    'assistantInputPlaceholder': `Haga una pregunta o describa lo que desea hacer…`,
    'assistantModeHint': `Info solo responde sobre uso. Trabajo conecta el modelo al servidor MCP para leer y cambiar tareas y pacientes vía GraphQL.`,
    'assistantModeInfo': `Info — cómo usar la app`,
    'assistantModel': `Modelo`,
    'assistantModeLabel': `Modo (obligatorio)`,
    'assistantModelHint': `p. ej. gpt-4o-mini o el id de su proveedor`,
    'assistantModePlaceholder': `Seleccione un modo…`,
    'assistantModeWorking': `Trabajo — herramientas MCP sobre datos en vivo`,
    'assistantNoApiKey': `Añada y guarde su clave API para empezar.`,
    'assistantSaveKey': `Guardar`,
    'assistantSelectMode': `Elija un modo antes de enviar.`,
    ...
    'assistantWorkingMcpNotice': `Modo trabajo usa el servidor MCP (http://127.0.0.1:8765/mcp por defecto). Raíz del repo: MCP_TRANSPORT=http MCP_GRAPHQL_URL=http://localhost:8000/graphql python -m mcp_server.server. Opcional: ASSISTANT_MCP_URL en Next.js.`,
  ...
  'fr-FR': {
    ...
    'assistantInputPlaceholder': `Posez une question ou décrivez ce que vous voulez faire…`,
    'assistantModeHint': `Info répond aux questions d'usage. Travail connecte le modèle au serveur MCP pour lire et modifier tâches et patients via GraphQL.`,
    'assistantModeInfo': `Info — utilisation de l'app`,
    'assistantModel': `Modèle`,
    'assistantModeLabel': `Mode (obligatoire)`,
    'assistantModelHint': `ex. gpt-4o-mini ou l'id du modèle chez votre fournisseur`,
    'assistantModePlaceholder': `Choisir un mode…`,
    'assistantModeWorking': `Travail — outils MCP sur données réelles`,
    'assistantNoApiKey': `Ajoutez et enregistrez votre clé API pour commencer.`,
    'assistantSaveKey': `Enregistrer`,
    'assistantSelectMode': `Choisissez un mode avant d'envoyer.`,
    'assistantSend': `Envoyer`,
    'assistantSending': `Envoi…`,
    'assistantTitle': `Assistant`,
    'assistantTooltip': `Ouvrir l'assistant démo (votre clé API)`,
    'assistantWorkingMcpNotice': `Le mode travail utilise le serveur MCP (défaut http://127.0.0.1:8765/mcp). Racine du dépôt : MCP_TRANSPORT=http MCP_GRAPHQL_URL=http://localhost:8000/graphql python -m mcp_server.server. Optionnel : ASSISTANT_MCP_URL pour Next.js.`,
  ...
  'nl-NL': {
    ...
    'assistantInputPlaceholder': `Stel een vraag of beschrijf wat u wilt doen…`,
    'assistantModeHint': `Info beantwoordt alleen gebruiksvragen. Werken koppelt het model aan de MCP-server om taken en patiënten via GraphQL te lezen en te wijzigen.`,
    'assistantModeInfo': `Info — app gebruiken`,
    'assistantModel': `Model`,
    'assistantModeLabel': `Modus (verplicht)`,
    'assistantModelHint': `bijv. gpt-4o-mini of model-id van uw provider`,
    'assistantModePlaceholder': `Kies een modus…`,
    'assistantModeWorking': `Werken — MCP-tools op live data`,
    'assistantNoApiKey': `Voeg uw API-sleutel toe en sla op om te starten.`,
    'assistantSaveKey': `Opslaan`,
    'assistantSelectMode': `Kies een modus voordat u verzendt.`,
    'assistantSend': `Verzenden`,
    'assistantSending': `Verzenden…`,
    'assistantTitle': `Assistent`,
    'assistantTooltip': `Demo-assistent openen (eigen API-sleutel)`,
    'assistantWorkingMcpNotice': `Werkmodus gebruikt de MCP-server (standaard http://127.0.0.1:8765/mcp). Reporoot: MCP_TRANSPORT=http MCP_GRAPHQL_URL=http://localhost:8000/graphql python -m mcp_server.server. Optioneel ASSISTANT_MCP_URL voor Next.js.`,
  ...
  'pt-BR': {
    ...
    'assistantInputPlaceholder': `Faça uma pergunta ou descreva o que deseja fazer…`,
    'assistantModeHint': `Info responde só sobre uso. Trabalho conecta o modelo ao servidor MCP para ler e alterar tarefas e pacientes via GraphQL.`,
    'assistantModeInfo': `Info — como usar o app`,
    'assistantModel': `Modelo`,
    'assistantModeLabel': `Modo (obrigatório)`,
    'assistantModelHint': `ex.: gpt-4o-mini ou id do modelo do provedor`,
    'assistantModePlaceholder': `Selecione um modo…`,
    'assistantModeWorking': `Trabalho — ferramentas MCP em dados ao vivo`,
    'assistantNoApiKey': `Adicione e salve sua chave API para começar.`,
    'assistantSaveKey': `Salvar`,
    'assistantSelectMode': `Escolha um modo antes de enviar.`,
    'assistantSend': `Enviar`,
    'assistantSending': `Enviando…`,
    'assistantTitle': `Assistente`,
    'assistantTooltip': `Abrir assistente demo (sua própria chave API)`,
    'assistantWorkingMcpNotice': `Modo trabalho usa o servidor MCP (padrão http://127.0.0.1:8765/mcp). Raiz do repo: MCP_TRANSPORT=http MCP_GRAPHQL_URL=http://localhost:8000/graphql python -m mcp_server.server. Opcional: ASSISTANT_MCP_URL no Next.js.`,
